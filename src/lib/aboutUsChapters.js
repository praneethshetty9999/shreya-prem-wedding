// "Our Story" timeline data. Copy is placeholder — real chapter text to be
// supplied later.
//
// `photos` lists the image paths that cycle inside that chapter's frame on
// hover (see ChapterFrame). Drop new images under
// `public/about-us/<id>/` and add their `/about-us/<id>/…` paths here — an
// empty array just renders the frame outline with nothing inside.
export const ABOUT_US_CHAPTERS = [
  {
    id: 'two-ships',
    eyebrow: 'Boston · Summer 2023',
    title: 'Two Ships in\nthe Same Harbor',
    text: 'Prem had just wrapped up years of grueling emergency medicine training in Atlanta and arrived in Boston for a Global Emergency Medicine fellowship at Brigham & Women’s hospital — finally ready, he thought, for a well-earned bachelor chapter of fun. Just a few miles away, Shreya was deep in the throes of architecture school at the Harvard Graduate School of Design, running on caffeine and sawdust. Neither had any idea the other existed — yet.',
    photos: [
      '/about-us/two-ships/000040.jpg',
      '/about-us/two-ships/massachussetts (28).jpg',
    ],
  },
  {
    id: 'swipe-right',
    eyebrow: 'The App',
    title: 'The Swipe Right',
    text: 'One day, a funny comment on Prem\'s Hinge profile caught Shreya\'s eye — she swiped right and sent him a message. They chatted, and quickly formed a connection over caretaking for disabled dogs, a very specific and unexpected point of connection. But with exams and final review season hitting, she eventually left him on read. Luckily, they’d already exchanged instagrams. For weeks they watched each other\'s stories and grew quietly, mutually curious.',
    photos: [
      '/about-us/swipe-right/IMG_1781.JPEG',
      '/about-us/swipe-right/massachussetts (30b).JPG',
      '/about-us/swipe-right/new mexico (2b).jpeg',
    ],
  },
  {
    ...
    photos: [
      '/about-us/dm-heard-around-the-world/IMG_2913.JPEG',
      '/about-us/dm-heard-around-the-world/party-xmas (2).JPG',
    ],
  },
  {
    id: 'she-planned-to-leave-by-9',
    eyebrow: 'Cambridge · January 2024',
    title: 'She Planned to Leave by 9…\nShe Did Not Leave by 9.',
    ...
    photos: [
      '/about-us/she-planned-to-leave-by-9/IMG_1646.JPEG',
      '/about-us/she-planned-to-leave-by-9/IMG_1724.JPEG',
      '/about-us/she-planned-to-leave-by-9/IMG_5355.JPEG',
      '/about-us/she-planned-to-leave-by-9/IMG_7349.JPEG',
      '/about-us/she-planned-to-leave-by-9/IMG_8144.JPEG',
      '/about-us/she-planned-to-leave-by-9/IMG_9111.JPEG',
    ],
  },
  {
    id: 'murder-cabin',
    eyebrow: 'Akureyri, Iceland · March 2024',
    title: 'The Murder Cabin\nThat Made It Official',
  ...
  {
    id: 'going-everywhere',
    eyebrow: 'The World, Together',
    title: 'Going Everywhere,\n Especially Nowhere',
    ...
    photos: [
      '/about-us/going-everywhere/iceland (40).jpg',
      '/about-us/going-everywhere/sicily (13).JPG',
      '/about-us/going-everywhere/uk countryside (13).JPG',
      '/about-us/going-everywhere/uk countryside (23).JPG',
      '/about-us/going-everywhere/uk countryside (6).jpg',
    ],
  },
  {
    id: 'families-meet',
    eyebrow: 'Park City, Utah · Thanksgiving 2024',
    title: 'The Families Meet\n(in a snowy location, obviously)',
  ...
  {
    id: 'wolf-moon',
    eyebrow: 'Settermoen, Norway · January 2025',
    title: 'A Wolf Moon\nand A Question',
  ...
  },
  {
    ...
    photos: [
      '/about-us/party-before-the-wedding/000045230054.jpg',
      '/about-us/party-before-the-wedding/Photo03_10_Original.JPEG',
      '/about-us/party-before-the-wedding/Photo16_23_Original.JPEG',
    ],
  },
  {
    id: 'finding-the-fort',
    eyebrow: 'India · The Wedding Recce',
    ...
    photos: [
      ...
      '/about-us/finding-the-fort/alila (16b).JPEG',
      '/about-us/finding-the-fort/alila (9).JPEG',
    ],
  },
  {
    id: 'island-and-mainland',
    eyebrow: "Martha's Vineyard · The Next Chapter",
